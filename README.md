...
- Solution URL: [Add solution URL here](https://github.com/christencodes/Character-Counter)
- Live Site URL: [Add live site URL here](https://christencodes.github.io/Character-Counter/)
